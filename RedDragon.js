...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     await KUMUTHU.send5ButImg(from, `` + '' + teksehmazeh, `© ${botname}`, KUMUTHU, [{"urlButton": {"displayText": "YouTube📍","url": `${websitex}`}}])
  }
  break
        case 'userlimit': 
        if (isBan) return reply(mess.ban)	 			
...
if (!isCreator) return replay(mess.owner)
                ...
                let anu = await store.chats.all().map(v => v.id)
                let ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "916909137213-1604595598@g.us"}, "message": {orderMessage: {itemCount: 999999999,status: 200, thumbnail: fs.readFileSync('./Android/AllData/theme/cheemspic.jpg'), surface: 200, message: `${ownername}'s Broadcast`, orderTitle: `${botname}`, sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
KUMUTHU.sendMessage(from, {image:{url:buffer}, caption:"Here you go!"}, {quoted:m})
break
...
case 'naruto':
	...
	if (isBanChat) return reply(mess.banChat)
				...
				KUMUTHU.sendMessage(from, { caption: `Here you go!`, image: { url: pickRandom(data.result) }, buttons: but, footer: `${botname}` }, { quoted: m })
 			    break
case 'yaoi':
			if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
...
if (isBanChat) return reply(mess.banChat)
                ...
                KUMUTHU.sendMessage(m.chat, { image: buf, caption: `Made by ${botname}` }, { quoted: m}).catch ((err) => reply(mess.error))
                }
                break
case 'gayeffect': {
	if (isBan) return reply(mess.ban)	 			
...
if (isBanChat) return reply(mess.banChat)
             ...
             let anu = await maker.textpro(link, q)
                KUMUTHU.sendMessage(m.chat, { image: { url: anu }, caption: `Made by ${global.botname}` }, { quoted: m })
             }
             break
...
KUMUTHU.sendMessage(from, {image:{url:teds}, caption:"Done!"}, {quoted:m})
} else if (args[0] === 'glow') {
if (args.length < 2) return reply(`Example :\n${prefix + command + ' ' + args[0]} ${global.ownername}`)
...
if (isBanChat) return reply(mess.banChat)
     ...
     reply(mess.wait)   
     console.log(anui)
    KUMUTHU.sendMessage(from, {image:{url:anui}, caption:"Here you go!"}, {quoted:m})
}
   break
  case 'whitebear':{
  	if (isBan) return reply(mess.ban)	 			
...
console.log(anu)
KUMUTHU.sendMessage(from,{image:{url:anu}, caption:"Here you go!"},{quoted:m})
}
break
case 'retro':{
	if (isBan) return reply(mess.ban)	 			
...
let mese = await KUMUTHU.sendMessage(m.chat, {image:{url:emoji.images[4].url}, caption: `Made by ${global.botname}`}, {quoted:m})
...
if (isBanChat) return reply(mess.banChat)
             ...
             if (/1917/.test(command)) link = 'https://textpro.me/1917-style-text-effect-online-980.html'
                if (/leaves/.test(command)) link = 'https://textpro.me/natural-leaves-text-effect-931.html'
             let anu = await maker.textpro(link, q)
                KUMUTHU.sendMessage(m.chat, { image: { url: anu }, caption: `Made by ${global.botname},For my Darling ` }, { quoted: m })
             }
             break
            case 'drakorxxx':
               if (isBan) return reply(mess.ban)	 			
...
break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Phone Number :* ${anu.message.nomer_hp}\n${dragonemoji} *Shuzi Angka Figures :* ${anu.message.angka_shuzi}\n${dragonemoji} *Positive Energy :*\n- Riches : ${anu.message.energi_positif.kekayaan}\n- Health : ${anu.message.energi_positif.kesehatan}\n- Love : ${anu.message.energi_positif.cinta}\n- Stability : ${anu.message.energi_positif.kestabilan}\n- Percentage : ${anu.message.energi_positif.persentase}\n${dragonemoji} *Negative Energy :*\n- Dispute : ${anu.message.energi_negatif.perselisihan}\n- Lost : ${anu.message.energi_negatif.kehilangan}\n- Catastrophe : ${anu.message.energi_negatif.malapetaka}\n- Destruction : ${anu.message.energi_negatif.kehancuran}\n- Percentage : ${anu.message.energi_negatif.persentase}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Dream :* ${anu.message.mimpi}\n${dragonemoji} *Meaning :* ${anu.message.arti}\n${dragonemoji} *Solution :* ${anu.message.solusi}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Your Name :* ${anu.message.nama_anda.nama}\n${dragonemoji} *Your Birth :* ${anu.message.nama_anda.tgl_lahir}\n${dragonemoji} *Couple Name :* ${anu.message.nama_pasangan.nama}\n${dragonemoji} *Born Couple :* ${anu.message.nama_pasangan.tgl_lahir}\n${dragonemoji} *Results :* ${anu.message.result}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Husband's Name :* ${anu.message.suami.nama}\n${dragonemoji} *Husband Born :* ${anu.message.suami.tgl_lahir}\n${dragonemoji} *Wife's Name :* ${anu.message.istri.nama}\n${dragonemoji} *Born Wife :* ${anu.message.istri.tgl_lahir}\n${dragonemoji} *Results :* ${anu.message.result}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Your Name :* ${anu.message.nama_anda.nama}\n${dragonemoji} *Your Birth :* ${anu.message.nama_anda.tgl_lahir}\n${dragonemoji} *Couple Name :* ${anu.message.nama_pasangan.nama}\n${dragonemoji} *Born Couple :* ${anu.message.nama_pasangan.tgl_lahir}\n${dragonemoji} *Positive Side :* ${anu.message.sisi_positif}\n${dragonemoji} *Negative Side :* ${anu.message.sisi_negatif}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'artinama': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Name :* ${anu.message.nama}\n${dragonemoji} *Meaning :* ${anu.message.arti}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Name :* ${anu.message.nama}\n${dragonemoji} *Born :* ${anu.message.tgl_lahir}\n${dragonemoji} *Life Path :* ${anu.message.life_path}\n${dragonemoji} *Destiny :* ${anu.message.destiny}\n${dragonemoji} *Destiny Desire :* ${anu.message.destiny_desire}\n${dragonemoji} *Personality :* ${anu.message.personality}\n${dragonemoji} *Percentage :* ${anu.message.persentase_kecocokan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendImage(m.chat,  anu.message.gambar, `${dragonemoji} *Your Name :* ${anu.message.nama_anda}\n${dragonemoji} *Couple Name :* ${anu.message.nama_pasangan}\n${dragonemoji} *Positive Side :* ${anu.message.sisi_positif}\n${dragonemoji} *Negative Side :* ${anu.message.sisi_negatif}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Wedding Date :* ${anu.message.tanggal}\n${dragonemoji} *Characteristics :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Born :* ${anu.message.hari_lahir}\n${dragonemoji} *Business :* ${anu.message.usaha}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Born :* ${anu.message.hari_lahir}\n${dragonemoji} *Sustenance :* ${anu.message.rejeki}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Analysis :* ${anu.message.analisa}\n${dragonemoji} *Root Number :* ${anu.message.angka_akar}\n${dragonemoji} *Nature :* ${anu.message.sifat}\n${dragonemoji} *Element :* ${anu.message.elemen}\n${dragonemoji} *Lucky Numbers :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Analysis :* ${anu.message.analisa}\n${dragonemoji} *Sector :* ${anu.message.sektor}\n?? *Element :* ${anu.message.elemen}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendImage(m.chat, anu.message.image, `${dragonemoji} *Born :* ${anu.message.tgl_lahir}\n${dragonemoji} *Tarot Symbol :* ${anu.message.simbol_tarot}\n${dragonemoji} *Meaning :* ${anu.message.arti}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Name :* ${anu.message.nama}\n${dragonemoji} *Born :* ${anu.message.tahun_lahir}\n${dragonemoji} *Gender :* ${anu.message.jenis_kelamin}\n${dragonemoji} *Kua Number :* ${anu.message.angka_kua}\n${dragonemoji} *Group :* ${anu.message.kelompok}\n${dragonemoji} *Character :* ${anu.message.karakter}\n${dragonemoji} *Good Sector :* ${anu.message.sektor_baik}\n${dragonemoji} *Bad Sector :* ${anu.message.sektor_buruk}`, m)
            }
            break
            case 'haribaik': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Born :* ${anu.message.tgl_lahir}\n${dragonemoji} *When Challenged :* ${anu.message.kala_tinantang}\n${dragonemoji} *Info :* ${anu.message.info}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
            ...
            case 'harinaas': case 'harisial': {
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Day Of Birth :* ${anu.message.hari_lahir}\n${dragonemoji} *Date Of Birth :* ${anu.message.tgl_lahir}\n${dragonemoji} *Fateful Day :* ${anu.message.hari_naas}\n${dragonemoji} *Info :* ${anu.message.catatan}\n${dragonemoji} *Notes :* ${anu.message.info}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Day Of Birth :* ${anu.message.hari_lahir}\n${dragonemoji} *Date Of Birth :* ${anu.message.tgl_lahir}\n${dragonemoji} *Dragon Day Direction :* ${anu.message.arah_naga_hari}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Day Of Birth :* ${anu.message.hari_lahir}\n${dragonemoji} *Date Of Birth :* ${anu.message.tgl_lahir}\n${dragonemoji} *Sustenance Direction :* ${anu.message.arah_rejeki}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'peruntungan': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Name :* ${anu.message.nama}\n${dragonemoji} *Born :* ${anu.message.tgl_lahir}\n${dragonemoji} *Fortune Of The Year :* ${anu.message.peruntungan_tahun}\n${dragonemoji} *Results :* ${anu.message.result}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Date :* ${anu.message.tanggal}\n${dragonemoji} *Number Of Neptune :* ${anu.message.jumlah_neptu}\n${dragonemoji} *Day Character :* ${anu.message.watak_hari}\n${dragonemoji} *Dragon Day :* ${anu.message.naga_hari}\n${dragonemoji} *Good Hour :* ${anu.message.jam_baik}\n${dragonemoji} *Birth Character :* ${anu.message.watak_kelahiran}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Name :* ${anu.message.nama}\n${dragonemoji} *Born :* ${anu.message.tgl_lahir}\n${dragonemoji} *Lifeline :* ${anu.message.garis_hidup}`, m)
            }
            break
            case 'keberuntungan': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Name :* ${anu.message.nama}\n${dragonemoji} *Born :* ${anu.message.tgl_lahir}\n${dragonemoji} *Results :* ${anu.message.result}`, m)
            }
            break
            case 'memancing': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Date :* ${anu.message.tgl_memancing}\n${dragonemoji} *Results :* ${anu.message.result}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Results :* ${anu.message.result}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
	...
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Zodiac :* ${anu.message.zodiak}\n${dragonemoji} *Number :* ${anu.message.nomor_keberuntungan}\n${dragonemoji} *Aroma :* ${anu.message.aroma_keberuntungan}\n${dragonemoji} *Planet :* ${anu.message.planet_yang_mengitari}\n${dragonemoji} *Flower :* ${anu.message.bunga_keberuntungan}\n${dragonemoji} *Color :* ${anu.message.warna_keberuntungan}\n${dragonemoji} *Stone :* ${anu.message.batu_keberuntungan}\n${dragonemoji} *Element :* ${anu.message.elemen_keberuntungan}\n${dragonemoji} *Zodiac Couple :* ${anu.message.pasangan_zodiak}\n${dragonemoji} *Notes :* ${anu.message.catatan}`, m)
            }
            break
            case 'shio': {
            	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                ...
                if (anu.status == false) return reply(anu.message)
                KUMUTHU.sendText(m.chat, `${dragonemoji} *Results :* ${anu.message}`, m)
            }
            break
	    case 'tiktok':{
  	if (isBan) return reply(mess.ban)
...
break
 ...
 reply(mess.error) 
   ...
   const xeonytiktoknowm = musim_rambutan.result.nowatermark
    KUMUTHU.sendMessage(from, { video: { url: xeonytiktoknowm }, caption: "Here you go!" }, { quoted: m })
   }
  break
  case 'tiktokaudio':
case 'tiktokmusic':
	...
	if (isBanChat) return reply(mess.banChat)
        ...
        if (stderr.trim()) reply(stderr)
            ...
            case 'web': case'script': case 'qr': case 'scan': {
                ...
                result = fs.readFileSync(`./DragonMedia/image/qr.jpg`)
				KUMUTHU.sendMessage(m.chat, { image: result },{caption: '*📷 Scan Me 🙃✅*\n\nPowerd by: ◉ *ʀᴇᴅ-ᴅʀᴀɢᴏɴ-ʙᴏᴛ*'}, { quoted: m })
            }
...
thumbnail: fs.readFileSync("Android/AllData/theme/cheemspic.jpg"),
mediaType:1,
...
┃╠${dragonemoji} ${prefix}qr (Scan Qr code)
...
┃╔════💠 HOROSCOPE 💠══╗
┃║
┃╠${dragonemoji} ${prefix}nomorhoki (indo)
┃╠${dragonemoji} ${prefix}artimimpi (indo)
┃╠${dragonemoji} ${prefix}artinama (indo)
┃╠${dragonemoji} ${prefix}ramaljodoh (indo)
┃╠${dragonemoji} ${prefix}ramaljodohbali (indo)
┃╠${dragonemoji} ${prefix}suamiistri (indo)
┃╠${dragonemoji} ${prefix}ramalcinta (indo)
┃╠${dragonemoji} ${prefix}cocoknama (indo)
┃╠${dragonemoji} ${prefix}pasangan (indo)
┃╠${dragonemoji} ${prefix}jadiannikah (indo)
┃╠${dragonemoji} ${prefix}sifatusaha (indo)
┃╠${dragonemoji} ${prefix}rezeki (indo)
┃╠${dragonemoji} ${prefix}pekerjaan (indo)
┃╠${dragonemoji} ${prefix}nasib (indo)
┃╠${dragonemoji} ${prefix}penyakit (indo)
┃╠${dragonemoji} ${prefix}tarot (indo)
┃╠${dragonemoji} ${prefix}fengshui (indo)
┃╠${dragonemoji} ${prefix}haribaik (indo)
┃╠${dragonemoji} ${prefix}harisangar (indo)
┃╠${dragonemoji} ${prefix}harisial (indo)
┃╠${dragonemoji} ${prefix}nagahari (indo)
┃╠${dragonemoji} ${prefix}arahrezeki (indo)
┃╠${dragonemoji} ${prefix}peruntungan (indo)
┃╠${dragonemoji} ${prefix}weton (indo)
┃╠${dragonemoji} ${prefix}karakter (indo)
┃╠${dragonemoji} ${prefix}keberuntungan (indo)
┃╠${dragonemoji} ${prefix}memancing (indo)
┃╠${dragonemoji} ${prefix}masasubur (indo)
┃╠${dragonemoji} ${prefix}zodiak (indo)
┃╠${dragonemoji} ${prefix}shio (indo)
┃╚══════════════════
┗━❯ *${ownername}*`,
                            footer: KUMUTHU.user.name,
                            buttons,
...
┗━━❯ ${pushname} ❮━😎`,
            ...
            case 'islamicmenu': {
                ...
                let buttons = [
                    ...
                    {buttonId: `${prefix}donate`, buttonText: {displayText: '⫷ INFO ⫸'}, type: 1}]
                let buttonMessage = {
                    image: { url: picak+'Islmic Menu'},
                caption: `
┏━❯ ${botname} ❮━━😎 
┃╔════💠 ISLAMIC 💠══╗
┃║	        
┃╠${dragonemoji} ${prefix}juzamma
┃╚═════════════☬
┗━━❯ ${pushname} ❮━😎`,
            footer: KUMUTHU.user.name,
            buttons,
...
┗━━❯ ${pushname} ❮━😎`,
            ...
            😋MR: ☬𝔻𝔸ℝ𝕂༒ℕ𝕀𝕋ℝ𝕆࿐  ===
            and all the red dragon team members.
            Don't forget to visit our website🪐
            ⚽⚾🥎🏀🏐🏈🏉🔥`,unicorn, [{"urlButton": {"displayText": `${button}`,"url": `${btnurl}`}},{"urlButton": {"displayText": "Red Dragon Website🔖","url": `https://sites.google.com/view/red-dragon-bot/home`}},{"quickReplyButton": {"displayText": "⫷ ALIVE ⫸","id": 'alive'}},{"quickReplyButton": {"displayText": "⫷ OWNER ⫸","id": 'owner'}}] )
            break
            default:
                if (budy.startsWith('=>')) {
                    if (!isCreator) return reply(mess.owner)
